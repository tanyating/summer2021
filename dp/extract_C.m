function [g,h1,h2,h3,h4,o1,o2,o3,o4,r] = extract_C(C_red,p,Nt,center_show)
...
% r as average true positive rate per pair of (t,R).
%
...
r = mean(diag(ovtruetrans)); % avg rate of correct (t,R)
